...
import { listCustomerInvoices, createCustomerInvoice, updateCustomerInvoice, deleteCustomerInvoice } from '../../api/customer';
  ...
  program
    ...
    .action(async (opts) => {
      ...
      try {
        ...
        await updateCustomerInvoice(client, opts.customerId, parseInt(opts.invoiceId), dto);
