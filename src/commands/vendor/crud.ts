...
export function registerCrudCommands(
  ...
  vendor
    ...
    .option('--point-of-origin <origin>', '发货地/产地')
    ...
    .option('--employee-count <count>', '员工人数')
